// REQUIRES: stablehlo
<<<<<<< HEAD
// RUN: ttmlir-opt --stablehlo-pipeline="mesh-shape=1,8" --stablehlo-to-ttir-pipeline --ttir-to-ttnn-backend-pipeline="system-desc-path=%system_desc_path% mesh-shape=1,8" -o %t.mlir %s
// RUN: ttmlir-translate --ttnn-to-flatbuffer -o %t.ttnn %t.mlir
=======
// RUN: ttmlir-opt --stablehlo-pipeline="mesh-shape=1,8 automatic-arg-analysis" --stablehlo-to-ttir-pipeline %s | \
