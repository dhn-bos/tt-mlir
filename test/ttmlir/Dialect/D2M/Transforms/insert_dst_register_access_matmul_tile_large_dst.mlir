...
module {
  ...
  func.func @generic_matmul(
    ...
    ^compute0(%cb0: memref<3x3x!ttcore.tile<32x32, f32>, #l1_>, %cb1: memref<3x2x!ttcore.tile<32x32, f32>, #l1_>, %cb2: memref<3x2x!ttcore.tile<32x32, f32>, #l1_>):
      ...
      // CHECK: %[[INIT_VAL:.*]] = affine.load %{{.*}}[%[[INIT_I]], %[[INIT_J]]] : memref<1x1x!ttcore.tile<32x32, f32>, strided<[2, 1], offset: ?>, #l1>
      // CHECK: affine.store %[[INIT_VAL]], %[[DST]][0, %[[INIT_I]], %[[INIT_J]]] : memref<8x1x1x!ttcore.tile<32x32, f32>, #dst>
      ...
      // CHECK: %[[B_VAL:.*]] = affine.load %{{.*}}[%[[K]], %[[J]]] : memref<3x1x!ttcore.tile<32x32, f32>, strided<[2, 1], offset: ?>, #l1>
      // CHECK: %[[C_VAL:.*]] = affine.load %[[DST]][0, %[[I]], %[[J]]] : memref<8x1x1x!ttcore.tile<32x32, f32>, #dst>
      ...
      // CHECK: affine.store %[[MATMUL_RESULT]], %[[DST]][1, %[[I]], %[[J]]] : memref<8x1x1x!ttcore.tile<32x32, f32>, #dst>
      %c0 = arith.constant 0 : index
      ...
      // CHECK: %[[FINAL_VAL:.*]] = affine.load %[[DST]][1, %[[WB_I]], %[[WB_J]]] : memref<8x1x1x!ttcore.tile<32x32, f32>, #dst>
      // CHECK: affine.store %[[FINAL_VAL]], %{{.*}}[%[[WB_I]], %[[WB_J]]] : memref<1x1x!ttcore.tile<32x32, f32>, strided<[2, 1], offset: ?>, #l1>
    }
    return
  }
}
